...
app.state.config.ENABLE_ROSE_API = ENABLE_ROSE_API
app.state.config.ROSE_BASE_URLS = ROSE_BASE_URLS
app.state.config.ROSE_API_CONFIGS = ROSE_API_CONFIGS

app.state.ROSE_MODELS = {}
...
app.state.config.RAG_ROSE_BASE_URL = RAG_ROSE_BASE_URL
app.state.config.RAG_ROSE_API_KEY = RAG_ROSE_API_KEY
...
app.state.EMBEDDING_FUNCTION = get_embedding_function(
    ...
    (
        ...
        else app.state.config.RAG_ROSE_BASE_URL
    ),
    (
        app.state.config.RAG_OPENAI_API_KEY
        if app.state.config.RAG_EMBEDDING_ENGINE == "openai"
        else app.state.config.RAG_ROSE_API_KEY
    ),
